...
targets = samples['stress rate'].astype(str).to_numpy() 
...
# mean_HF_of_all_samples.drop("Inverse Difference Moment", inplace=True, axis=1)
...
# mean_HF_of_all_samples.drop("Sum Average", inplace=True, axis=1)
# mean_HF_of_all_samples.drop("Entropy", inplace=True, axis=1)
# mean_HF_of_all_samples.drop("Difference Variance", inplace=True, axis=1)
# #mean_HF_of_all_samples.drop("Info. Measure of Correlation 1", inplace=True, axis=1)
